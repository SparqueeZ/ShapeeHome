    ...
    <div class="choiceContainer">
      <article v-for="choice in choiceList" class="choiceItem">
        <input
          type="radio"
          name="choice"
          :id="`${choiceName}${choice.choiceNumber}`"
          @click="emit('saveChoice', Number(choice.choiceNumber), props.step)"
        />
        <label :for="`${choiceName}${choice.choiceNumber}`">
...
onMounted(() => {
  ...
  if (saveDevis && saveDevis[props.step]) {
